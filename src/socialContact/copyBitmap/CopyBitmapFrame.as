package socialContact.copyBitmap
{
   ...
   public class CopyBitmapFrame extends Sprite
   {
      ...
      public function CopyBitmapFrame(param1:socialContact.copyBitmap.CopyBitmapMode)
      {
         super();
         this._mode = param1;
         this._init();
      ...
      private function _upDataView(param1:Event) : void
      {
         ...
         this._copyCancelBt.x = this._mode.endX - this._copyCancelBt.width > this._mode.startX - this._copyCancelBt.width ? Number(this._mode.endX - this._copyCancelBt.width) : Number(this._mode.startX - this._copyCancelBt.width);
         this._copyCancelBt.y = this._mode.endY + this._copyCancelBt.height / 2 > this._mode.startY + this._copyCancelBt.height / 2 ? Number(this._mode.endY + this._copyCancelBt.height / 2) : Number(this._mode.startY + this._copyCancelBt.height / 2);
      ...
      {
         if(Boolean(this._areaView))
         {
            removeChild(this._areaView);
         }
         this._areaView = null;
         if(Boolean(this._bgView))
         {
         ...
         if(Boolean(this._copyOkBt))
         {
            ObjectUtils.disposeObject(this._copyOkBt);
         }
         this._copyOkBt = null;
         if(Boolean(this._copyCancelBt))
         {
