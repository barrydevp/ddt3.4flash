package store.view.exalt
{
   ...
   public class StoreExaltBG12 extends Sprite implements IStoreViewBG
   {
      ...
      public function StoreExaltBG12()
      {
         super();
         this.init();
         this.initEvent();
         ...
         while(_loc1_ < this._pointArray.length)
         {
            switch(_loc1_)
            {
               case 0:
                  ...
                  break;
               case 1:
                  _loc2_ = new ExaltItemCell1(_loc1_);
                  break;
            }
...
//            SocketManager.Instance.out.sendItemExalt();
      ...
      private function isExalt() : Boolean
      {
         ...
         if(StrengthStone(this._items[0]).itemInfo == null || ExaltItemCell1(this._items[1]).itemInfo == null)
         {
      ...
      {
         var _loc2_:ExaltItemCell1 = null;
         var _loc3_:InventoryItemInfo = null;
         var _loc4_:int = 0;
         if(param1.currentTarget is ExaltItemCell1)
         {
            _loc2_ = param1.currentTarget as ExaltItemCell1;
            _loc3_ = _loc2_.info as InventoryItemInfo;
            if(Boolean(_loc3_))
            {
               if(ExaltItemCell1(this._items[1]).actionState)
               {
                  ExaltItemCell1(this._items[1]).actionState = false;
               }
      ...
      public function dragDrop(param1:BagCell) : void
      {
         ...
         for each(_loc2_ in this._items)
         {
            if(Boolean(_loc2_))
            {
               ...
               else if(_loc2_ is ExaltItemCell1)
               {
                  ...
                  else if(param1.info.CanStrengthen && this.equipisAdapt(_loc3_))
                  {
                     ...
                     ExaltItemCell1(this._items[1]).actionState = true;
                     return;
                  }
               }
            }
