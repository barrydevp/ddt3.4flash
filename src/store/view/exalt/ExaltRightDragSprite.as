package store.view.exalt
{
   ...
   public class ExaltRightDragSprite extends Sprite implements IAcceptDrag
   {
       
      
      public function ExaltRightDragSprite()
      {
         super();
      }
      ...
      public function dragDrop(param1:DragEffect) : void
      {
         ...
         {
            _loc2_ = ExaltManager.EQUIP_MOVE2;
         }
         else
         {
            _loc2_ = ExaltManager.ITEM_MOVE2;
         }
