package store.view.exalt
{
   ...
   public class ExaltBagListView extends BagListView
   {
	   
	   
	   public function ExaltBagListView(param1:int, param2:int = 7, param3:int = 49)
	   {
		   ...
		   {
			   ExaltManager.instance.addEventListener(ExaltManager.ITEM_MOVE,this.equipMoveHandler);
			   ExaltManager.instance.addEventListener(ExaltManager.ITEM_MOVE2,this.equipMoveHandler2);
		   }
	   }
	   
	   override protected function createCells() : void
	   {
		   var _loc1_:ExaltEquipListCell = null;
	   ...
	   private function createBagCell(param1:int, param2:ItemTemplateInfo = null, param3:Boolean = true) : ExaltEquipListCell
	   {
		   var _loc4_:ExaltEquipListCell = new ExaltEquipListCell(param1,param2,param3);
	   ...
	   override public function dispose() : void
	   {
		   ...
		   ExaltManager.instance.removeEventListener(ExaltManager.ITEM_MOVE,this.equipMoveHandler);
		   ExaltManager.instance.removeEventListener(ExaltManager.ITEM_MOVE2,this.equipMoveHandler2);
		   super.dispose();
	   }
   }
}
