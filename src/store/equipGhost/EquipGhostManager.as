package store.equipGhost
{
   ...
   public class EquipGhostManager extends EventDispatcher
   {
      ...
      private static var _instance:store.equipGhost.EquipGhostManager;
      ...
      public static function getInstance() : store.equipGhost.EquipGhostManager
      {
      ...
      private function calulateRatio() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         if(Boolean(this._stoneMaterial) && Boolean(this._equip))
         {
            _loc4_ = (_loc1_ = PlayerManager.Instance.Self.getGhostDataByCategoryID(this._equip.CategoryID)) == null ? 0 : int(_loc1_.level);
            _loc2_ = this._luckyMaterial == null ? 1 : Number(1 + parseFloat(this._luckyMaterial.Property2) / 100);
      ...
      public function getPorpertyData(param1:InventoryItemInfo, param2:PlayerInfo = null) : GhostPropertyData
      {
         ...
         param2 ||= PlayerManager.Instance.Self;
