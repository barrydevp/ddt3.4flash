package store.forge.wishBead
{
   ...
   public class WishBeadMainView extends Sprite implements Disposeable
   {
      ...
      private var _proBagList:store.forge.wishBead.WishBeadBagListView;
      
      private var _leftDrapSprite:store.forge.wishBead.WishBeadLeftDragSprite;
      
      private var _rightDrapSprite:store.forge.wishBead.WishBeadRightDragSprite;
      
      private var _itemCell:store.forge.wishBead.WishBeadItemCell;
      
      private var _equipCell:store.forge.wishBead.WishBeadEquipCell;
      
      private var _continuousBtn:SelectedCheckButton;
      
      private var _doBtn:SimpleBitmapButton;
      
      private var _tip:store.forge.wishBead.WishTips;
      ...
      private function initView() : void
      {
         ...
         this._bagList = new store.forge.wishBead.WishBeadBagListView(BagInfo.EQUIPBAG,7,21);
         PositionUtils.setPos(this._bagList,"wishBeadMainView.bagListPos");
         this.refreshBagList();
         this._proBagList = new store.forge.wishBead.WishBeadBagListView(BagInfo.PROPBAG,7,21);
         ...
         this._equipCell = new store.forge.wishBead.WishBeadEquipCell(0,null,true,new Bitmap(new BitmapData(60,60,true,0)),false);
         ...
         this._itemCell = new store.forge.wishBead.WishBeadItemCell(0,null,true,new Bitmap(new BitmapData(60,60,true,0)),false);
      ...
      private function bagInfoChangeHandler(param1:BagEvent) : void
      {
         ...
         {
            _loc4_ = WishBeadManager.instance.getCanWishBeadData();
      ...
      {
         this._leftDrapSprite = new store.forge.wishBead.WishBeadLeftDragSprite();
         ...
         this._rightDrapSprite = new store.forge.wishBead.WishBeadRightDragSprite();
