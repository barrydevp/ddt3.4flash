   ...
   public class FineForgeView extends Sprite implements Disposeable
   {
      ...
      private function init():void
      {
         ...
         while (_loc9_ < 6)
         {
            ...
            _loc7_.x = _loc9_ % 2 == 0 ? Number(49) : Number(183);
      ...
      private function __onCellClick(param1:MouseEvent):void
      {
         ...
         var _loc4_:QuickBuyFrame = ComponentFactory.Instance.creatCustomObject("core.QuickFrame");
         _loc4_.setTitleText(LanguageMgr.GetTranslation("tank.view.store.matte.goldQuickBuy"));
         _loc4_.itemID = _loc3_.TemplateID;
      ...
      private function __onClickForgeBtn(param1:MouseEvent):void
      {
         ...
         SocketManager.Instance.out.sendForgeSuit(this._select.selected ? 0 : 1);
      }
      ...
      private function updateCellBgView():void
      {
         ...
         while (_loc3_ < this._cell.length)
         {
            ...
            _loc1_.bgType = _loc3_ < this._index ? int(2) : int(1);
      ...
      private function get currentIndex():int
      {
         ...
         return _loc1_ == 0 ? int(14) : int(_loc1_);
      }
      ...
      private function getforgeEffectState(param1:int):int
      {
         ...
         {
            _loc3_ = this.currentIndex == 14 ? int(3) : int(2);
         }
         else if (_loc2_ == param1 + 1)
         {
            _loc3_ = this.currentIndex == 14 ? int(2) : int(1);
         }
         else
         {
            _loc3_ = 1;
      ...
      public function dispose():void
      {
         ...
         this._cell = null;
         while (Boolean(this._hBox.numChildren))
         {
