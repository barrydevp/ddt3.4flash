package store.fineStore.view
{
   ...
   public class FineStoreView extends Sprite implements Disposeable
   {
      ...
      private var _forgeView:store.fineStore.view.FineForgeView;
      ...
      private var _ghostView:store.fineStore.view.FineGhostView;
      ...
      {
         if (this._tabVbox && contains(this._tabVbox))
         {
            setChildIndex(this._tabVbox, numChildren - 1);
         }
      }
      ...
      private function __changeHandler(param1:Event):void
      {
         ...
         var _loc2_:String = String(_forgeGroupType[this._btnGroup.selectIndex]);
         ...
         switch (int(this._btnGroup.selectIndex))
         {
            ...
            case 2:
               ...
               if (!this._bringUpView)
               {
                  ...
                  this.addChild(this._bringUpView);
