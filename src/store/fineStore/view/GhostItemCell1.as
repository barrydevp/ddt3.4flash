package store.fineStore.view
{
   ...
   public class GhostItemCell1 extends StoreCell
   {
       
      
      public function GhostItemCell1(param1:int)
      {
      ...
      override public function dragDrop(param1:DragEffect) : void
      {
         ...
         if((Boolean(_loc5_ = param1.data as InventoryItemInfo)) && param1.action != "split")
         {
