package hall
{
   ...
   public class HallStateView extends BaseStateView
   {
      ...
      override public function enter(param1:BaseStateView, param2:Object = null) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this._needShowOpenTipActArr.length)
         {
            if(!this._isShowActTipDic[this._needShowOpenTipActArr[_loc5_]])
            {
               this._isShowActTipDic[this._needShowOpenTipActArr[_loc5_]] = false;
            }
            _loc5_++;
         }
      ...
      {
         HallIconManager.instance.updateSwitchHandler(HallIconType.CONSORTIABATTLE,true);
      ...
      private function __checkAvatarCollectionTime(param1:Event) : void
      {
         ...
         if(Boolean(param1))
         {
            AvatarCollectionManager.instance.removeEventListener("avatar_collection_data_complete",this.__checkAvatarCollectionTime);
         }
         if(!AvatarCollectionManager.instance.maleUnitList)
         {
            return;
         }
         var _loc7_:Array = AvatarCollectionManager.instance.maleUnitList;
         _loc7_ = _loc7_.concat(AvatarCollectionManager.instance.femaleUnitList);
         _loc7_ = _loc7_.concat(AvatarCollectionManager.instance.weaponUnitList);
         _loc2_ = 0;
         while(_loc2_ < _loc7_.length)
         {
            ...
            {
               _loc4_ = Number(_loc3_.endTime.getTime());
               _loc5_ = TimeManager.Instance.Now().getTime();
               if(_loc4_ - _loc5_ <= 0)
               {
                  (_loc6_ = new ChatData()).channel = 21;
                  _loc6_.childChannelArr = [ChatInputView.SYS_TIP,ChatInputView.GM_NOTICE];
                  _loc6_.type = 108;
                  _loc6_.msg = LanguageMgr.GetTranslation("avatarCollection.noTime.tipTxt");
      ...
      private function checkShowActTip() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = 0;
         for(_loc1_ in WonderfulActivityManager.Instance.stateDic)
         {
            _loc2_ = 0;
            while(_loc2_ < this._needShowOpenTipActArr.length)
            {
               if(_loc1_ == String(this._needShowOpenTipActArr[_loc2_]) && !this._isShowActTipDic[this._needShowOpenTipActArr[_loc2_]])
               {
                  ChatManager.Instance.sysChatAmaranth(LanguageMgr.GetTranslation("wonderfulActivity.startTip" + this._needShowOpenTipActArr[_loc2_]));
                  this._isShowActTipDic[this._needShowOpenTipActArr[_loc2_]] = true;
               }
               _loc2_++;
            }
         }
      ...
      private function createActAwardChat() : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this._needShowAwardTipActArr.length)
            {
               if(_loc1_ == String(this._needShowAwardTipActArr[_loc2_]) && Boolean(WonderfulActivityManager.Instance.stateDic[_loc1_]))
               {
                  _loc3_ = new ChatData();
                  _loc3_.channel = ChatInputView.COMPLEX_NOTICE;
                  _loc3_.childChannelArr = [ChatInputView.SYS_TIP,ChatInputView.GM_NOTICE];
                  _loc3_.type = ChatFormats.CLICK_ACT_TIP + this._needShowAwardTipActArr[_loc2_];
                  _loc3_.actId = WonderfulActivityManager.Instance.getActIdWithViewId(this._needShowAwardTipActArr[_loc2_]);
                  _loc3_.msg = LanguageMgr.GetTranslation("wonderfulActivity.awardTip" + this._needShowAwardTipActArr[_loc2_]);
      ...
      private function initBuild() : void
      {
         ...
         this.setBuildState(6,_loc1_ >= 3 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(5,_loc1_ >= 5 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(11,_loc1_ >= 6 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(2,_loc1_ >= 7 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(7,_loc1_ >= 2 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(1,_loc1_ >= 2 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(0,_loc1_ >= 8 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(9,_loc1_ >= 10 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(10,_loc1_ >= 12 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(4,_loc1_ >= 1 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
         this.setBuildState(8,_loc1_ >= 14 ? Boolean(Boolean(Boolean(true))) : Boolean(Boolean(Boolean(false))));
      }
      ...
      private function checkShowVipAlert() : void
      {
         ...
         if(!_loc2_.isSameDay && !VipController.instance.isRechargePoped)
         {
            VipController.instance.isRechargePoped = true;
            if(_loc2_.IsVIP)
            {
               if(_loc2_.VIPLeftDays <= VIP_LEFT_DAY_TO_COMFIRM && _loc2_.VIPLeftDays >= 0 || _loc2_.VIPLeftDays == VIP_LEFT_DAY_FIRST_PROMPT)
               {
                  _loc1_ = "";
                  if(_loc2_.VIPLeftDays == 0)
                  {
                     if(_loc2_.VipLeftHours > 0)
                     {
                        _loc1_ = LanguageMgr.GetTranslation("ddt.vip.vipView.expiredToday",_loc2_.VipLeftHours);
                     }
                     else if(_loc2_.VipLeftHours == 0)
                     {
                        _loc1_ = LanguageMgr.GetTranslation("ddt.vip.vipView.expiredHour");
                     }
                     else
                     {
                        _loc1_ = LanguageMgr.GetTranslation("ddt.vip.vipView.expiredTrue");
                     }
                  }
                  else
                  {
                     _loc1_ = LanguageMgr.GetTranslation("ddt.vip.vipView.expired",_loc2_.VIPLeftDays);
                  }
                  this._renewal = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),_loc1_,LanguageMgr.GetTranslation("ddt.vip.vipView.RenewalNow"),"",false,false,false,LayerManager.ALPHA_BLOCKGOUND);
                  this._renewal.moveEnable = false;
                  this._renewal.addEventListener(FrameEvent.RESPONSE,this.__goRenewal);
               }
            }
            else if(_loc2_.VIPExp > 0)
            {
               if(_loc2_.LastDate.valueOf() < _loc2_.VIPExpireDay.valueOf() && _loc2_.VIPExpireDay.valueOf() <= _loc2_.systemDate.valueOf())
               {
      ...
      override public function leaving(param1:BaseStateView) : void
      {
         ...
         if(Boolean(this._hallMainView.parent))
         {
      ...
      {
         if(Boolean(this._farmIcon) && Boolean(this._farmIcon.parent))
         {
            return;
         }
