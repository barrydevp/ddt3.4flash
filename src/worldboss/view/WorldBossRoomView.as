package worldboss.view
{
   ...
   public class WorldBossRoomView extends Sprite implements Disposeable
   {
      ...
      private var _sceneMap:worldboss.view.WorldBossScneneMap;
      
      private var _chatFrame:ChatView;
      
      private var _roomMenuView:worldboss.view.RoomMenuView;
      
      private var _bossHP:worldboss.view.WorldBossHPScript;
      
      private var _totalContainer:worldboss.view.WorldBossRoomTotalInfoView;
      
      private var _resurrectFrame:worldboss.view.WorldBossResurrectView;
      
      private var _buffIcon:worldboss.view.WorldBossBuffIcon;
      ...
      private var _hideBtn:worldboss.view.WorldBossHideBtn;
      ...
      private function initialize() : void
      {
         ...
         this._diff = WorldBossManager.Instance.bossInfo.fightOver ? int(int(0)) : int(int(WorldBossManager.Instance.bossInfo.getLeftTime()));
      ...
      public function setMap(param1:Point = null) : void
      {
         ...
         if(!this._sceneMap)
         {
            this._sceneMap = new worldboss.view.WorldBossScneneMap(this._model,this._sceneScene,this._model.getPlayers(),_loc6_,_loc5_,_loc3_,_loc4_,_loc8_);
      ...
      public function showBuff(param1:Event = null) : void
      {
         ...
         this.clearBuff();
         var _loc3_:int = 0;
         while(_loc3_ < WorldBossManager.Instance.bossInfo.myPlayerVO.buffs.length)
         {
            _loc2_ = new BuffItem(WorldBossManager.Instance.bossInfo.myPlayerVO.buffs[_loc3_]);
            this._buffIconArr.push(_loc2_);
            addChild(_loc2_);
            _loc2_.y = 540;
            _loc2_.x = 440 + this._buffIconArr.length * 60;
            _loc3_++;
         }
      }
      ...
      {
         this._resurrectFrame = new worldboss.view.WorldBossResurrectView(param1);
