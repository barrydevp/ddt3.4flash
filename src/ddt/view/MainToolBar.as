package ddt.view
{
   ...
   public class MainToolBar extends Sprite
   {
      ...
      private static var _instance:ddt.view.MainToolBar;
      ...
      public static function get Instance() : ddt.view.MainToolBar
      {
         if(_instance == null)
         {
            _instance = new ddt.view.MainToolBar();
         }
         return _instance;
      }
...
//         TaskManager.MainFrame.switchVisible();
      ...
      {
         SoundManager.instance.play("003");
         if(Boolean(this._bagShineEffect) && this._bagEffectEnable)
         {
...
//		 trace("test");
      ...
      {
         if(Boolean(TaskManager.MainFrame.parent))
         {
            return true;
         }
