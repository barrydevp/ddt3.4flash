package ddt.data.goods
{
   ...
   public class ShopItemInfo extends EventDispatcher
   {
      ...
      private var _templateInfo:ddt.data.goods.ItemTemplateInfo;
      
      private var _itemPrice:ddt.data.goods.ItemPrice;
      ...
      public function set TemplateInfo(param1:ddt.data.goods.ItemTemplateInfo) : void
      {
         this._templateInfo = param1;
      }
      
      public function get TemplateInfo() : ddt.data.goods.ItemTemplateInfo
      {
      ...
      public function getItemPrice(param1:int) : ddt.data.goods.ItemPrice
      {
         switch(param1)
         {
            case 1:
               return new ddt.data.goods.ItemPrice(this.AUnit == -1 ? null : new Price(this.AValue1 * this.Beat,this.APrice1),this.AUnit == -1 ? null : new Price(this.AValue2 * this.Beat,this.APrice2),this.AUnit == -1 ? null : new Price(this.AValue3 * this.Beat,this.APrice3));
            case 2:
               return new ddt.data.goods.ItemPrice(this.BUnit == -1 ? null : new Price(this.BValue1 * this.Beat,this.BPrice1),this.BUnit == -1 ? null : new Price(this.BValue2 * this.Beat,this.BPrice2),this.BUnit == -1 ? null : new Price(this.BValue3 * this.Beat,this.BPrice3));
            case 3:
               return new ddt.data.goods.ItemPrice(this.CUnit == -1 ? null : new Price(this.CValue1 * this.Beat,this.CPrice1),this.CUnit == -1 ? null : new Price(this.CValue2 * this.Beat,this.CPrice2),this.CUnit == -1 ? null : new Price(this.CValue3 * this.Beat,this.CPrice3));
            default:
               return new ddt.data.goods.ItemPrice(new Price(this.AValue1,this.APrice1),new Price(this.AValue2,this.APrice2),new Price(this.AValue3,this.APrice3));
         }
      }
