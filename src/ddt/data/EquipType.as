package ddt.data
{
   ...
   public class EquipType
   {
      ...
      {
         return param1 == EquipType.PET_EGG;
      }
      ...
      {
         return Boolean(param1) && param1.Property4 == "2" && param1.Count > 1;
      }
      ...
      {
         var $info:ItemTemplateInfo = param1;
         var isNotWeddingRing:Function = function(param1:ItemTemplateInfo):Boolean
         {
            switch(param1.TemplateID)
            {
               case 9022:
