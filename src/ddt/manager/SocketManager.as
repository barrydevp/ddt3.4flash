package ddt.manager
{
   ...
   import bigBugleRank.data.BigBugleRankEvent;
   ...
   import winLeagueRank.data.WinLeagueRankEvent;
   ...
   public class SocketManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.SocketManager;
       
      
      private var _socket:ByteSocket;
      
      private var _out:ddt.manager.GameSocketOut;
      ...
      public function SocketManager()
      {
         ...
         this._out = new ddt.manager.GameSocketOut(this._socket);
      }
      
      public static function get Instance() : ddt.manager.SocketManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.SocketManager();
         }
         return _instance;
      }
      ...
      public function get out() : ddt.manager.GameSocketOut
      {
         return this._out;
      }
         ...
         try
         {
            ...
            switch(main)
            {
               ...
               case ePackageType.CONSUME_RANK:
                  ...
                  break;
               case ePackageType.RECHARGE_RANK:
                  dispatchEvent(new RechargeRankEvent(RechargeRankEvent.RECHARGERANKUPDATE,pkg));
                  break;
               case ePackageType.FIGHTPOWER_RANK:
                  dispatchEvent(new FightPowerRankEvent(FightPowerRankEvent.UPDATE,pkg));
                  break;
               case ePackageType.LEVEL_RANK:
                  dispatchEvent(new LevelRankEvent(LevelRankEvent.UPDATE,pkg));
                  break;
               case ePackageType.ONLINE_RANK:
                  dispatchEvent(new OnlineRankEvent(OnlineRankEvent.UPDATE,pkg));
                  break;
               case ePackageType.BIGBULE_RANK:
                  dispatchEvent(new BigBugleRankEvent(BigBugleRankEvent.UPDATE,pkg));
                  break;
               case ePackageType.GIFT_RANK:
                  dispatchEvent(new GiftRankEvent(GiftRankEvent.UPDATE,pkg));
                  break;
               case ePackageType.WIN_RANK:
                  dispatchEvent(new WinRankEvent(WinRankEvent.UPDATE,pkg));
                  break;
               case ePackageType.WIN_GUILD_RANK:
                  dispatchEvent(new WinGuildRankEvent(WinGuildRankEvent.UPDATE,pkg));
                  break;
               ...
               case ePackageType.STORE_FINE_SUIT:
                  ...
                  break;
               case ePackageType.WIN_LEAGUE_RANK:
                  dispatchEvent(new WinLeagueRankEvent(WinLeagueRankEvent.UPDATE,pkg));
                  break;
               case 145:
               ...
               case 391:
               case 392:
                  dispatchEvent(new PkgEvent(PkgEvent.format(main),pkg));
                  break;
               case 402:
                  dispatchEvent(new PkgEvent(PkgEvent.format(main),pkg));
                  break;
               case 329:
                  ...
                  break;
               case 377:
                  tester = int(pkg.readUnsignedByte());
                  dispatchEvent(new PkgEvent(PkgEvent.format(main,tester),pkg));
            }
            return;
         }
         catch(err:Error)
      ...
      private function activityPackageHandler(param1:PackageIn) : void
      {
         ...
         if(_loc2_ == ChickActivationType.CHICKACTIVATION)
         {
      ...
      private function activitySystem(param1:PackageIn) : void
      {
         ...
         if(_loc2_ >= 176 && _loc2_ <= 180)
         {
            dispatchEvent(new CrazyTankSocketEvent("happyRecharge",param1,_loc2_));
         }
         else if(_loc2_ >= 32 && _loc2_ <= 36)
         {
            dispatchEvent(new CrazyTankSocketEvent("catchbeast_begin",param1,_loc2_));
         }
      ...
      {
         var _loc2_:LittleGameSocketEvent = null;
         var _loc3_:int = param1.readByte();
         switch(_loc3_)
         {
            case LittleGamePackageInType.WORLD_LIST:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.WORLD_LIST,param1);
               break;
            case LittleGamePackageInType.START_LOAD:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.START_LOAD,param1);
               dispatchEvent(_loc2_);
               return;
            case LittleGamePackageInType.ADD_SPRITE:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.ADD_SPRITE,param1);
               break;
            case LittleGamePackageInType.REMOVE_SPRITE:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.REMOVE_SPRITE,param1);
               break;
            case LittleGamePackageInType.GAME_START:
               ...
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.GAME_START,param1);
               break;
            case LittleGamePackageInType.MOVE:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.MOVE,param1);
               break;
            case LittleGamePackageInType.UPDATE_POS:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.UPDATE_POS,param1);
               break;
            case LittleGamePackageInType.ADD_OBJECT:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.ADD_OBJECT,param1);
               break;
            case LittleGamePackageInType.UPDATELIVINGSPROPERTY:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.UPDATELIVINGSPROPERTY,param1);
               break;
            case LittleGamePackageInType.DoAction:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.DOACTION,param1);
               break;
            case LittleGamePackageInType.DoMovie:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.DOMOVIE,param1);
               break;
            case LittleGamePackageInType.GETSCORE:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.GETSCORE,param1);
               break;
            case LittleGamePackageInType.INVOKE_OBJECT:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.INVOKE_OBJECT,param1);
               break;
            case LittleGamePackageInType.SETCLOCK:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.SETCLOCK,param1);
               break;
            case LittleGamePackageInType.PONG:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.PONG,param1);
               break;
            case LittleGamePackageInType.NET_DELAY:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.NET_DELAY,param1);
               break;
            case LittleGamePackageInType.KICK_PLAYE:
               _loc2_ = new LittleGameSocketEvent(LittleGameSocketEvent.KICK_PLAYE,param1);
         }
         if(Boolean(_loc2_))
         {
            LittleGamePacketQueue.Instance.addQueue(_loc2_);
         }
      }
