   ...
   public class GameSocketOut
   {
      ...
      public function sendBuyGoods(param1:Array, param2:Array, param3:Array, param4:Array, param5:Array, param6:Array = null, param7:int = 0, param8:Array = null, param9:Array = null) : void
      {
         ...
         if(param1.length > 50)
         {
            ...
            {
               _loc10_ = param9.splice(0,50);
            }
            else
            {
               _loc10_ = param9;
            }
            this.sendBuyGoods(param1.splice(0,50),param2.splice(0,50),param3.splice(0,50),param4.splice(0,50),param5.splice(0,50),param6.splice(0,50),param7,param8,_loc10_);
            this.sendBuyGoods(param1,param2,param3,param4,param5,param6,param7,param8,param9);
            return;
         }
         var _loc11_:PackageOut = new PackageOut(ePackageType.BUY_GOODS);
         var _loc12_:int = int(param1.length);
         _loc11_.writeInt(_loc12_);
         var _loc13_:uint = 0;
         while(_loc13_ < _loc12_)
         {
            ...
            {
               _loc11_.writeUTF(param6[_loc13_]);
            }
            _loc11_.writeInt(param4[_loc13_]);
            _loc13_++;
         }
         _loc11_.writeInt(param7);
         this.sendPackage(_loc11_);
      }
      ...
      {
         var _loc2_:uint = 0;
         var _loc3_:PackageOut = new PackageOut(ePackageType.SEND_MAIL);
         _loc3_.writeUTF(param1.NickName);
         _loc3_.writeUTF(param1.Title);
         _loc3_.writeUTF(param1.Content);
         _loc3_.writeBoolean(param1.isPay);
         _loc3_.writeInt(param1.hours);
         _loc3_.writeInt(param1.SendedMoney);
         while(_loc2_ < MailManager.Instance.NUM_OF_WRITING_DIAMONDS)
         {
            if(Boolean(param1["Annex" + _loc2_]))
            {
               _loc3_.writeByte(param1["Annex" + _loc2_].split(",")[0]);
               _loc3_.writeInt(param1["Annex" + _loc2_].split(",")[1]);
            }
            else
            {
               _loc3_.writeByte(0);
      ...
      {
		  trace("game send: " + ePackageType.getName(param1._code));
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.HOTSPRING_CMD_B);
         _loc1_.writeByte(HotSpringPackageType.CONTINU_BY_MONEY);
         this.sendPackage(_loc1_);
      }
      ...
      {
         var _loc2_:uint = 0;
         var _loc3_:PackageOut = new PackageOut(ePackageType.HOTSPRING_CMD);
         _loc3_.writeByte(HotSpringPackageType.TARGET_POINT);
         var _loc4_:Array = param1.walkPath.concat();
         var _loc5_:Array = [];
         while(_loc2_ < _loc4_.length)
         {
            _loc5_.push(int(_loc4_[_loc2_].x),int(_loc4_[_loc2_].y));
            _loc2_++;
         }
         var _loc6_:String = String(_loc5_.toString());
         _loc3_.writeUTF(_loc6_);
         _loc3_.writeInt(param1.playerInfo.ID);
         _loc3_.writeInt(param1.currentWalkStartPoint.x);
         _loc3_.writeInt(param1.currentWalkStartPoint.y);
         _loc3_.writeInt(1);
         _loc3_.writeInt(param1.playerDirection);
         this.sendPackage(_loc3_);
      }
      ...
      public function sendSortCards(param1:Vector.<int>) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:PackageOut = new PackageOut(ePackageType.CARDS_DATA);
         _loc4_.writeInt(4);
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc3_ = _loc6_ + CardModel.EQUIP_CELLS_SUM;
      ...
      public function sendGoodsExchange2(param1:Vector.<SendGoodsExchangeInfo>, param2:int, param3:int, param4:int) : void
      {
         var _loc5_:PackageOut = new PackageOut(ePackageType.GOODS_EXCHANGE);
         _loc5_.writeInt(param2);
         _loc5_.writeInt(param3);
      ...
      {
         var _loc5_:int = 0;
         var _loc6_:PackageOut = new PackageOut(ePackageType.PET);
         _loc6_.writeByte(CrazyTankPackageType.EAT_PETS);
         _loc6_.writeInt(param1);
         _loc6_.writeInt(param2);
         if(param2 == 1)
         {
            _loc6_.writeInt(param4.length);
            _loc5_ = 0;
            while(_loc5_ < param4.length)
            {
               _loc6_.writeInt(param4[_loc5_][0]);
               _loc6_.writeInt(param4[_loc5_][1].TemplateID);
               _loc5_++;
            }
         }
         else
      ...
      public function toSpread(param1:Array, param2:int, param3:Boolean) : void
      {
         ...
         var _loc5_:PackageOut = new PackageOut(ePackageType.FARM);
         _loc5_.writeByte(FarmPackageType.PAY_FIELD);
         _loc5_.writeInt(param1.length);
      ...
      public function toFarmHelper(param1:Array, param2:Boolean) : void
      {
         ...
         var _loc4_:PackageOut = new PackageOut(ePackageType.FARM);
         _loc4_.writeByte(FarmPackageType.HELPER_SWITCH_FIELD);
         _loc4_.writeInt(param1.length);
         var _loc5_:int = 0;
         while(_loc5_ < param1.length)
         {
            _loc3_ = param1[_loc5_];
            _loc4_.writeInt(_loc3_.currentfindIndex);
            _loc4_.writeInt(_loc3_.currentSeedText);
            _loc4_.writeInt(_loc3_.currentSeedNum);
            _loc4_.writeInt(_loc3_.currentFertilizerText);
            _loc4_.writeInt(_loc3_.autoFertilizerNum);
            _loc4_.writeBoolean(param2);
            _loc5_++;
         }
         this.sendPackage(_loc4_);
      ...
      {
         var _loc3_:PackageOut = new PackageOut(ePackageType.CRYPTBOSS);
         _loc3_.writeByte(3);
         _loc3_.writeInt(param1);
         _loc3_.writeInt(param2);
         this.sendPackage(_loc3_);
      ...
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.GETPLAYERSPECIAL);
         _loc2_.writeInt(param1);
         this.sendPackage(_loc2_);
      }
      ...
      {
         var _loc4_:PackageOut = null;
         (_loc4_ = new PackageOut(ePackageType.USERLOVECHOCOLATE)).writeByte(param1);
         _loc4_.writeInt(param2);
         _loc4_.writeInt(param3);
         this.sendPackage(_loc4_);
      }
      ...
      {
         var _loc2_:* = 0;
         var _loc3_:PackageOut = new PackageOut(ePackageType.WONDERFUL_GETREWARD);
         _loc3_.writeInt(param1.length);
         var _loc4_:int = 0;
         while(_loc4_ < param1.length)
         {
            _loc3_.writeUTF(param1[_loc4_].activityId);
            _loc3_.writeInt(param1[_loc4_].awardCount);
            _loc3_.writeInt(param1[_loc4_].giftIdArr.length);
            _loc2_ = 0;
            while(_loc2_ < param1[_loc4_].giftIdArr.length)
            {
               if(param1[_loc4_].giftIdArr[_loc2_] is GiftChildInfo)
               {
                  _loc3_.writeUTF(param1[_loc4_].giftIdArr[_loc2_].giftId);
                  _loc3_.writeInt(param1[_loc4_].giftIdArr[_loc2_].index);
               }
               else
               {
                  _loc3_.writeUTF(param1[_loc4_].giftIdArr[_loc2_]);
                  _loc3_.writeInt(0);
               }
               _loc2_++;
            }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.RECHARGE_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateFightPowerRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.FIGHTPOWER_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateLevelRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.LEVEL_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateOnlineRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.ONLINE_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateBigBugleRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.BIGBULE_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateWinRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.WIN_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateWinGuildRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.WIN_GUILD_RANK);
         this.sendPackage(_loc1_);
      }
      
      public function updateGiftRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.GIFT_RANK);
         this.sendPackage(_loc1_);
      }
      ...
      {
         var _loc7_:PackageOut = new PackageOut(ePackageType.PET);
         _loc7_.writeByte(CrazyTankPackageType.PET_WASH_BONE);
         _loc7_.writeInt(param1);
      ...
      public function sendAvatarCollectionActive(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         (_loc5_ = new PackageOut(402)).writeByte(3);
         _loc5_.writeInt(param1);
         _loc5_.writeInt(param2);
         _loc5_.writeInt(param3);
         _loc5_.writeInt(param4);
      ...
      {
         var _loc4_:PackageOut = null;
         (_loc4_ = new PackageOut(402)).writeByte(4);
         _loc4_.writeInt(param1);
         _loc4_.writeInt(param2);
         _loc4_.writeInt(param3);
         this.sendPackage(_loc4_);
      ...
      {
         var _loc4_:PackageOut = null;
         (_loc4_ = new PackageOut(377)).writeByte(3);
         _loc4_.writeInt(param1);
         _loc4_.writeInt(param2);
         _loc4_.writeBoolean(param3);
         this.sendPackage(_loc4_);
      ...
      {
         var _loc4_:PackageOut = null;
         (_loc4_ = new PackageOut(377)).writeByte(4);
         _loc4_.writeBoolean(param1);
         _loc4_.writeBoolean(param2);
         _loc4_.writeBoolean(param3);
         this.sendPackage(_loc4_);
      ...
      {
         var _loc11_:PackageOut = null;
         (_loc11_ = new PackageOut(345)).writeInt(param3);
      ...
      public function updateWinLeagueRank() : void
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.WIN_LEAGUE_RANK);
         this.sendPackage(_loc1_);
      }
   }
}
