package ddt.loader
{
   ...
   public class StartupResourceLoader extends EventDispatcher
   {
      ...
      private static var _instance:ddt.loader.StartupResourceLoader;
      ...
      public static function get Instance() : ddt.loader.StartupResourceLoader
      {
         if(_instance == null)
         {
            _instance = new ddt.loader.StartupResourceLoader();
         }
         return _instance;
      }
      ...
      public function get progress() : int
      {
         ...
         return _loc1_ > 99 ? int(99) : int(_loc1_);
      }
      ...
      private function __onUIModuleProgress(param1:UIModuleEvent) : void
      {
         ...
         {
            this.setLoaderProgressArr(param1.module,_loc4_.progress);
         }
         ...
         var _loc6_:Number = 0;
         var _loc7_:uint = this._progressArr.length;
         _loc2_ = 0;
         while(_loc2_ < _loc7_)
         {
            _loc3_ = String(this._progressArr[_loc2_]);
            _loc6_ += this._progressArr[_loc3_];
            _loc2_++;
         }
         this._uimoduleProgress = int(_loc6_ / _loc7_ * _loc5_);
      }
      ...
      private function __onUIMoudleComplete(param1:UIModuleEvent) : void
      {
         ...
         if(param1.module == UIModuleTypes.TIMEBOX)
         {
            ...
            this.addLoader(LoaderCreate.Instance.creatGodCardListGroup());
            this.addLoader(LoaderCreate.Instance.creatGodCardPointRewardList());
            ...
            this.addLoader(LoaderCreate.Instance.createManualItemData());
            ...
            this.addLoader(this.creatRingSystemLoader());
            this.addLoader(LoaderCreate.Instance.createFineSuitInfoLoader());
      ...
      public function creatGodSyahLoader(param1:int = 7) : BaseLoader
      {
         ...
         var _loc3_:BaseLoader = LoaderManager.Instance.creatLoader(PathManager.solveRequestPath("SubActiveList.ashx"),6,_loc2_);
      ...
      {
         var _loc1_:BaseLoader = LoaderManager.Instance.creatLoader(PathManager.solveRequestPath("LoveLeveList.xml"),5);
      ...
      {
         var _loc1_:BaseLoader = LoaderManager.Instance.creatLoader(PathManager.solveRequestPath("SpiritInfoList.xml"),BaseLoader.COMPRESS_TEXT_LOADER);
